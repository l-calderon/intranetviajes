        ...
        <div class='flex justify-center min-h-screen'>
            <ul class="mx-auto grid max-w-7xl w-full grid-cols-4 gap-x-5 px-8">
                <li class="pb-2">
                    ...
                    <label
                        class="flex items-center px-16 py-3 rounded-lg dark:hover:bg-gray-800 dark:hover:text-white border-solid border-2 shadow-lg border-t-red-rv"
                        for="yes">
                    ...
                    <div
                        class="absolute bg-white shadow-lg p-6 w-full border mt-8 border-white-rv rounded-lg  mx-auto transition-all duration-500 ease-in-out translate-x-40 opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-x-1 max-w-custom-rv md:grid-cols-2 lg:grid-cols-3">
                        <div class="grid gap-16 md:grid-cols-2 lg:grid-cols-3">
                            <div
                                class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md border-2 border-red-rv">
                                <div class="relative bg-clip-border mt-4 mx-4 rounded-xl overflow-hidden bg-transparent
                                 text-gray-700 shadow-none !m-0 px-6 pb-px pt-px">
                                    <h3
                                        class="antialiased tracking-normal font-sans text-3xl text-red-rv italic 
                                    justify-center font-bold leading-snug text-blue-gray-900 flex gap-1 mt-4">
                                        Mis Datos
                                        <span
                                            class="block antialiased tracking-normal font-sans text-base font-semibold 
                                        leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span>
                                    </h3>
                                </div>
                                <div class="p-4 pb-3 border-blue-gray-50 self-center">
                                    <img src="/images/data.png" alt="" class="pb-0 w-40 mb-6">
                            ...
                            <div
                                class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md border-2 border-red-rv">
                                <div
                                    class="relative bg-clip-border mt-4 mx-4 rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none !m-0 px-6 pb-px pt-px">

                                    <h3
                                        class="antialiased tracking-normal font-sans text-3xl text-red-rv italic justify-center font-bold leading-snug text-blue-gray-900 flex gap-1 mt-4">
                                        Ficha Médica<span
                                            class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span>
                                    </h3>
                                </div>
                                <div class="p-4 pb-3 border-blue-gray-50 self-center">
                                    <img src="/images/nurse.png" alt="" class="pb-0 w-40 mb-6">
                                    <a href="{{ route('ficha-medica') }}">
                                        <x-primary-button>
                                            {{ __('VER MÁS') }}
                                        </x-primary-button>
                                    </a>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h3
                                        class="antialiased tracking-normal font-sans text-3xl text-red-rv italic justify-center font-bold leading-snug text-blue-gray-900 flex gap-1 mt-4">
                                        Ficha Nutricional<span
                                            class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span>
                                    </h3>
                                </div>
                                <div class="p-4 pb-3 border-blue-gray-50 self-center">
                                    <img src="/images/health.png" alt="" class="pb-0 w-40 mb-6">
                ...
                <li class="">
                    ...
                    <label
                        class="flex items-center px-16 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white border-solid border-2 shadow-lg border-t-red-rv"
                        for="no">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div
                        class="absolute bg-white shadow-lg left-16 w-full p-6 border mt-8 border-white-rv rounded-lg  mx-auto transition-all duration-500 ease-in-out translate-x-40 opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-x-1 max-w-custom-rv">
                        <div class="grid gap-16 md:grid-cols-2 lg:grid-cols-3">
                            <div
                                class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md border-2 border-red-rv">
                                <div
                                ...
                                <div class="p-4 pb-3 border-blue-gray-50 self-center">
                                    ...
                                    <button
                                        class="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-2 px-4 rounded-lg border bg-red-rv border-red-rv text-white-rv hover:opacity-75 focus:ring focus:ring-green-200 active:opacity-[0.85] block w-full mt-6"
                ...
                <li class="">
                    ...
                    <div
                        ...
                        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                            <div
                                class="relative flex w-full gap-4 border border-shadow-lg rounded hover:transition shadow-md hover:border-red-rv hover:shadow-red-rv">
                                <Link href={'/'} class='w-full overflow-hidden rounded'>
                                <img src="/images/ale.png" alt="Opa"
                                    class='object-cover my-auto rounded w-36  h-40 ' />
                                </Link>
                                    ...
                                    <div class='w-full py-4'>
                                        ...
                                        <p class=' flex items-center pt-1 text-sm text-black '>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                fill="currentColor" class="size-5 text-red-rv">
                                                <path
                            ...
                            <div
                                class="relative flex w-full gap-4 border border-shadow-lg rounded hover:transition shadow-md hover:border-red-rv hover:shadow-red-rv">
                                <Link href={'/'} class='w-full overflow-hidden rounded'>
                                <img src="/images/eri.png" alt="Opa"
                                    class='object-cover my-auto rounded w-36  h-40 ' />
                                </Link>
                                <div class='flex flex-col justify-between flex-grow gap03 px-2'>
                                    <div class='w-full py-4'>
                            ...
                            <div
                                class="relative flex w-full gap-4 border border-shadow-lg rounded hover:transition shadow-md hover:border-red-rv hover:shadow-red-rv">
                                <Link href={'/'} class='w-full overflow-hidden rounded'>
                                <img src="/images/lup.png" alt="Opa"
                                    class='object-cover my-auto rounded w-36  h-40 ' />
                                </Link>
                                <div class='flex flex-col justify-between flex-grow gap03 px-2'>
                                    <div class='w-full py-4'>
                ...
                <div
                    ...
                    <p class="mb-4 px-20 font-normal text-gray-700 text-center dark:text-gray-400">Al ingresar al
                        sistema esta de acuerdo con los <a href="#" target="_blank"
                            class="text-red-rv">términos y condiciones.</a></p>
